...
void Pause::Initialize() {
	...
	textureHandle_[static_cast<UINT>(TextureType::kBase)] = TextureManager::GetInstance()->LoadTexture("resources/Pause/option.png");
	textureHandle_[static_cast<UINT>(TextureType::kMark)] = TextureManager::GetInstance()->LoadTexture("resources/Pause/mark.png");
	textureHandle_[static_cast<UINT>(TextureType::kTutorial)] = TextureManager::GetInstance()->LoadTexture("resources/Pause/Tutorial.png");
